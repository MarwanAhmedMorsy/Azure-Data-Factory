...
This project demonstrates a complete data cleaning pipeline built using Azure Data Factory (ADF). The goal is to process raw transactional data and transform it into a clean, consistent, and analysis-ready dataset.
...
#### 2. Data Type Conversion
    ...
    Converted numeric columns from string → numeric(Integer)
        quantity
        unit_price
        Total Amount
...
## How to Run
    ...
    Monitor execution from the Output tab
